from app import app, mysql, MySQLdb, render_template, request, redirect, url_for, session, loggedin, hashlib, os

# http://localhost:5000/gnuproxy/admin/ - admin home page, view all accounts
...
# http://localhost:5000/gnuproxy/admin/account - create or edit account
...
# http://localhost:5000/gnuproxy/admin/emailtemplate - admin email template page, edit the existing template
@app.route('/admin/emailtemplate', methods=['GET', 'POST'])
